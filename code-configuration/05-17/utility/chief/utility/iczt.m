...
%          S.Forsythe, modified to reverse czt process.
...
[m1, n] = size(g1);
m=Nt;
if m == 1, g1 = g1(:); [m1, n] = size(g1); end
oldm = m1;
if ~exist('Nt')
    nT=size(g1,1);
end
if nargin < 2, k = Nt; end
...
%------- Reverse final multiply.
g1=g1./ww( m:(m+k-1),ones(1, n));
g=zeros(nfft,n);
g(m:(m+k-1),:)=g1;

function FigInfo=inputdlg_modeless(Prompt, Title, NumLines, DefAns,Resize)
%INPUTDLG_modeless Input dialog box.
...
FigInfo.InputFig=InputFig;
FigInfo.NumQuest=NumQuest;
FigInfo.EditHandle=EditHandle;

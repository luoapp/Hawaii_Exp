...
% tseries=times of individual data points, time_data=actual time series of
% collected data, db_data, phase data are from the FFT of the data.
%
...
cur_path=demo_dir;
cur_file=file;
[file,demo_dir] = uigetfile([demo_dir,'e*.*'],'Select Demo Data File To Open or Cancel To Exit');
if file == 0
...
for k=1:num_recs
    ...
    if k==1
        ...
        time = 0:time_int(1):(rec_len(1)-1)*time_int(1);
    end
    for j=1:num_digitizers
